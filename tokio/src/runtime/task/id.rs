...
impl Id {
    pub(crate) fn next() -> Self {
        ...
        crate::loom::lazy_static! {
            static ref TOKIO_RT_TASK_NEXT_ID: StaticAtomicU64 = StaticAtomicU64::new(1);
        }

        #[cfg(not(all(test, loom)))]
        rubicon::process_local! {
            static TOKIO_RT_TASK_NEXT_ID: StaticAtomicU64 = StaticAtomicU64::new(1);
        }

        loop {
            let id = TOKIO_RT_TASK_NEXT_ID.fetch_add(1, Relaxed);
